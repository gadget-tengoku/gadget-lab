...
ALL_THEMES = [
    ...
    # ===== 追加テーマ（11本） =====
    {
        'title': 'iPhone 15対応USB-Cイヤホン',
        'cat': 'イヤホン',
        'kw_short': 'iPhone 15 USB-C イヤホン',
        'keywords': ['Apple EarPods USB-C', 'Sony USB-C イヤホン', 'JBL Tune 310C USB-C', 'Anker Soundcore USB-C イヤホン', 'audio-technica USB-C イヤホン'],
        'must': ['イヤホン','EarPods','USB-C','Tune'],
        'exclude': ['ケース','カバー','変換アダプタ','ケーブル','交換'],
        'lead': 'iPhone 15からLightning端子がUSB-Cに変わり、これまでのイヤホンが使えなくなった方向け。USB-C直挿しで使えるイヤホンを厳選しました。',
        'problem': ['iPhone 15に変えたら今までのイヤホンが使えない','変換アダプタを毎回つけるのが面倒','音質が良いUSB-Cイヤホンを探している','Apple純正は本当にいいの？'],
        'conclusion': '純正で安心 → Apple EarPods USB-C｜音質重視 → JBL Tune 310C｜コスパ → Anker Soundcore USB-C',
        'decision': 'まず純正Apple EarPods USB-Cを試し、音質に不満があれば1万円以下の国内正規モデルを検討',
        'personas': [('📱','iPhone 15ユーザー','変換アダプタなしで直接使いたい'),('🎵','音質も重視','安いものより少し良い音で聴きたい'),('💼','通勤・カフェ作業','ノートPCでも兼用したい'),('💰','とにかく安く','5000円以下でちゃんと使えるものが欲しい')],
        'criteria': [('純正にこだわるかで予算が変わる','Apple EarPods USB-Cは純正で安心ですが平凡な音質。1万円台のJBL・Sonyの方が音質は上です。'),('PC兼用かで選ぶ','MacBookやWindowsノートでも使うなら、汎用性の高いSony・JBLを選びましょう。'),('リモコン付きかを確認','音量調整・通話切替リモコン付きモデルが便利です。')],
        'faq': [('Apple EarPods USB-Cの音質はどうですか？','標準的な音質で平凡な評価です。音質を求めるなら他社製のUSB-Cイヤホンを検討してください。'),('iPhone 14以前でも使えますか？','iPhone 14以前はLightning端子のため使えません。USB-C搭載のiPad・MacBookでは使用可能。'),('AndroidスマホのUSB-C端子でも使えますか？','基本的に使えますが、ハイレゾ対応かどうかは機種により異なります。'),('Bluetoothイヤホンと比べてどちらがいい？','音質と遅延の少なさは有線が有利。ただし取り回しの良さはBluetoothが有利です。'),('変換アダプタを使うのと何が違う？','変換アダプタは断線・接触不良のリスクあり。直挿しは故障リスクが低いです。')],
    },
    {
        'title': 'Apple Watch SE と Series 9 比較ガイド',
        'cat': 'スマートウォッチ',
        'kw_short': 'Apple Watch SE Series 9 比較',
        'keywords': ['Apple Watch SE 第2世代 本体', 'Apple Watch Series 9 本体', 'Apple Watch Ultra 2 本体', 'Apple Watch SE 40mm', 'Apple Watch Series 9 45mm'],
        'must': ['Apple Watch','Watch'],
        'exclude': ['バンド','ベルト','ケース','フィルム','充電','保護','交換'],
        'lead': 'Apple WatchのSEとSeries 9、価格差が約1万5千円。本当にSeries 9を買うべきか、SEで十分か、用途別に判断基準を解説します。',
        'problem': ['Apple Watch SEとSeries 9で迷っている','心電図・血中酸素は本当に必要？','常時表示ディスプレイは便利？','1万5千円の差額に見合う？'],
        'conclusion': 'コスパ重視 → SE（第2世代）｜健康管理を本格的に → Series 9｜タフネス重視 → Ultra 2',
        'decision': '健康管理を数値化したいならSeries 9一択。基本機能で十分ならSEで失敗しない',
        'personas': [('💰','コスパ重視・初Apple Watch','基本機能で十分・通知とSuicaが使えればOK'),('❤️','健康管理を本格的に','心電図・血中酸素・常時表示が欲しい'),('🏃','本格的なスポーツ','トレーニング機能・GPS精度を重視'),('🏔️','登山・アウトドア','頑丈さ・大型ディスプレイ・長時間バッテリー')],
        'criteria': [('心電図・血中酸素が必要かで決める','心電図機能はSeries 9以上のみ。健康診断レベルで使うならSeries 9一択です。'),('常時表示ディスプレイの使用頻度','腕を上げないと時刻が見えないSEに対し、Series 9は常時表示で時計らしさが上です。'),('予算1万5千円差を見比べる','SE（約34,800円）とSeries 9（約59,800円）。常時表示と健康機能に1万5千円の価値があるか判断しましょう。')],
        'faq': [('SEで物足りなくなることはありますか？','心電図・血中酸素・常時表示が欲しくなる人は2年で買い替えるケースがあります。'),('Series 9は何年使えますか？','Apple WatchはOSアップデートが3〜5年提供されます。Series 9なら2027〜2028年まで快適に使える見込み。'),('AndroidでApple Watchは使えますか？','使えません。iPhone専用です。'),('SEとSeries 9で電池持ちは違いますか？','どちらも約18時間。常時表示ONのSeries 9はやや消耗が早めです。'),('Suica・Apple Payはどちらでも使えますか？','SEもSeries 9もSuica・Apple Pay対応です。')],
    },
    {
        'title': '寝るときに使える睡眠用ワイヤレスイヤホン',
        'cat': 'イヤホン',
        'kw_short': '睡眠用イヤホン おすすめ',
        'keywords': ['Bose Sleepbuds 睡眠 イヤホン', 'Anker Soundcore Sleep A20', 'Soundcore Sleep A10', 'JBL 睡眠 ワイヤレス イヤホン', '睡眠用 ワイヤレス イヤホン'],
        'must': ['イヤホン','Sleep','Sleepbuds','Buds'],
        'exclude': ['ケース','カバー','イヤーパッド','交換','充電ケーブル'],
        'lead': '横向きで寝ても痛くない・パートナーのいびきや生活音をシャットアウトしたい方向け。睡眠特化のイヤホンを厳選しました。',
        'problem': ['横向きで寝ると普通のイヤホンが耳に当たって痛い','パートナーのいびきで眠れない','耳栓は完全に音をブロックして目覚ましが聞こえない','寝ているうちに外れる'],
        'conclusion': '機能性最強 → Bose Sleepbuds｜コスパ → Anker Soundcore Sleep A20｜入門 → Sleep A10',
        'decision': '小型設計（耳から飛び出さない）・自動音声フェードアウト・遮音性の3点で選ぶ',
        'personas': [('🛏️','横向きで寝る人','普通のイヤホンは痛くて寝られない'),('💤','寝つきが悪い','睡眠用音楽・ホワイトノイズで眠りたい'),('🚂','旅行・出張','飛行機・ホテルで耳栓代わりに使いたい'),('👫','パートナーのいびき対策','音をブロックしたいが目覚ましは聞きたい')],
        'criteria': [('完全ワイヤレスかつ小型を選ぶ','耳から飛び出さない設計のものを選びましょう。Boseは特に薄型設計です。'),('音声の自動フェードアウト機能','睡眠中に音量が自動で下がる機能があれば、夜中に目覚めずに済みます。'),('連続再生時間（ナイト1晩分）','最低6〜8時間連続使用できるモデルを選んでください。')],
        'faq': [('普通のワイヤレスイヤホンを寝るときに使ってもOK？','横向きで寝ると耳が痛くなります。睡眠用は耳から飛び出さない設計です。'),('音楽以外の用途は？','ホワイトノイズ・自然音・ASMRなどの再生に最適です。'),('Bose Sleepbudsの音楽再生機能は？','旧モデルは内蔵音源のみでしたが、最新版は通常のBluetooth音楽再生にも対応。'),('Anker Soundcore Sleep A20の特徴は？','コスパに優れ、自動音量調整・睡眠トラッキング機能を搭載しています。'),('片耳だけで使えますか？','多くのモデルが片耳使用に対応しています。')],
    },
    {
        'title': 'iPhone 15用 MagSafe充電器',
        'cat': 'モバイル',
        'kw_short': 'MagSafe 充電器 おすすめ',
        'keywords': ['Apple MagSafe 充電器 純正', 'Anker MagSafe 充電器 7.5W', 'Belkin BoostCharge Pro MagSafe', 'CIO MagSafe 充電器', 'Anker MagGo 充電器'],
        'must': ['MagSafe','MagGo','BoostCharge'],
        'exclude': ['ケース','カバー','ケーブル','交換','スタンド単体'],
        'lead': 'ケーブルを毎回挿す煩わしさをゼロに。マグネットでくっつけるだけで充電できるMagSafe充電器を比較します。',
        'problem': ['毎回ケーブルを挿すのが面倒','ベッドサイドで横になりながら充電したい','充電中もスマホを使いたい','MagSafeとQiの違いがわからない'],
        'conclusion': '純正で安心 → Apple MagSafe充電器｜コスパ → Anker MagGo｜デスクトップ用 → Belkin BoostCharge Pro',
        'decision': 'MagSafe認証品（15W）・スタンド型/パッド型・電源アダプタ別売の有無の3点で選ぶ',
        'personas': [('🛏️','ベッドサイド','寝る前に置くだけで充電したい'),('💼','デスクワーカー','作業中も画面を見ながら充電したい'),('🚗','車載用','運転中に充電とスマホナビを両立したい'),('💰','コスパ重視','純正は高いので安く済ませたい')],
        'criteria': [('MagSafe認証（15W）かを確認','MagSafe非認証品は7.5W止まりで充電速度が落ちます。Apple認証マークを確認しましょう。'),('スタンド型かパッド型かを選ぶ','デスク作業用ならスタンド型、ベッドサイドならパッド型がおすすめです。'),('電源アダプタが付属するか確認','MagSafe充電器単体は本体のみのモデルが多いです。20W以上のUSB-Cアダプタが別途必要です。')],
        'faq': [('MagSafeとQiの違いは何ですか？','MagSafeはマグネットで位置がずれず15W充電。Qiは位置合わせが必要で7.5W止まりです。'),('iPhone 12以降なら使えますか？','はい。iPhone 12以降全機種でMagSafe対応です。'),('ケースの上から充電できますか？','MagSafe対応ケースなら使用可能です。非対応ケースはMagSafeが効きません。'),('純正と社外品の違いは？','純正はApple認証で15W充電。社外品はMagSafe非認証で7.5W止まりが多いです。'),('AirPods Proも充電できますか？','MagSafe対応のAirPods Pro（第2世代）は充電できます。')],
    },
    {
        'title': 'ゲーミングメカニカルキーボード比較',
        'cat': 'ゲーミング',
        'kw_short': 'ゲーミングキーボード メカニカル',
        'keywords': ['Logicool G PRO X TKL キーボード', 'Razer BlackWidow V4 キーボード', 'SteelSeries Apex Pro TKL キーボード', 'Corsair K70 RGB キーボード', 'HyperX Alloy Origins キーボード'],
        'must': ['キーボード','Keyboard'],
        'exclude': ['キーキャップ','スイッチ','交換','補修','ケーブル','パームレスト'],
        'lead': '青軸のカチカチ音が好きな人・赤軸の静音性を取りたい人・茶軸のバランスを求める人へ。FPS・MMO別におすすめを解説します。',
        'problem': ['メンブレンキーボードのフニャ感が嫌','長時間タイピングで指が疲れる','軸の種類が多すぎて選べない','RGBライティングって本当に必要？'],
        'conclusion': 'プロFPS → Logicool G PRO X TKL（GX軸）｜コスパ → HyperX Alloy Origins｜タイピング重視 → Corsair K70',
        'decision': '青軸（カチカチ）・赤軸（リニア・ゲーム向き）・茶軸（バランス）から自分の好みで選ぶ',
        'personas': [('🎯','FPS本格派','レスポンスとコンパクトさを重視'),('🎮','RPG・MMO','テンキー付き・マクロ機能が欲しい'),('💻','タイピング重視','打鍵感の良さで作業効率を上げたい'),('💰','入門・コスパ','1万円台で本格的なメカニカルが欲しい')],
        'criteria': [('軸の種類で選ぶ','赤軸はリニアでゲーム向け、青軸はカチカチ音でタイピング感、茶軸は中間のバランス型です。'),('テンキーレス（TKL）か検討','FPSはマウスの可動域確保のためTKLが主流。MMOはテンキー付きが便利です。'),('USB Type-Cか有線取り外しを確認','Type-C・取り外し可能ケーブルなら持ち運び・買い替え時の負担が減ります。')],
        'faq': [('青軸・赤軸・茶軸の違いは？','青軸はクリック音とタクタイル感、赤軸はリニアで静音、茶軸は中間。ゲーム向けは赤軸が主流です。'),('メカニカルキーボードは何年使えますか？','スイッチの耐久寿命は5000万回以上。メンブレンの数倍長持ちします。'),('RGBライティングは必要ですか？','機能的には不要ですが、デスクの見栄えと気分が上がります。'),('テンキーレスとフルサイズどちらがいい？','FPSはTKL、MMO・事務作業はフルサイズが推奨です。'),('PS5でも使えますか？','USB接続のキーボードはPS5でも基本的に使えますが、ゲーム側の対応が必要です。')],
    },
    {
        'title': 'ノートPCスタンドおすすめ',
        'cat': 'PC周辺機器',
        'kw_short': 'ノートPCスタンド おすすめ',
        'keywords': ['BoYata ノートパソコンスタンド', 'MOFT ノートパソコンスタンド', 'Anker ノートパソコンスタンド', 'Bauhutte ノートパソコンスタンド', 'Logicool ノートパソコンスタンド'],
        'must': ['スタンド','ノートパソコン','MOFT','BoYata','Bauhutte'],
        'exclude': ['ケース','カバー','ケーブル','交換','クッション'],
        'lead': '猫背・首肩の痛みは作業姿勢が原因。ノートPCスタンドで目線を上げるだけで生産性と健康が改善します。',
        'problem': ['長時間作業で首・肩が痛い','Web会議で映りが悪い','カフェでも作業姿勢を保ちたい','デスクが熱くなる'],
        'conclusion': '安定感・耐荷重 → BoYata｜持ち運び → MOFT｜コスパ → Anker',
        'decision': '高さ調整可能・耐荷重5kg以上・折りたたみ可能の3点を満たすモデルを選ぶ',
        'personas': [('💼','在宅ワーカー','長時間作業の姿勢改善・首肩こり対策'),('☕','カフェ作業派','持ち運べて軽量なものが欲しい'),('📹','Web会議が多い','カメラ位置を目線に合わせたい'),('🎮','ゲーマー','17インチノートを安定させたい')],
        'criteria': [('耐荷重5kg以上を選ぶ','MacBook Pro 16インチは2.1kg。ケース込みで考えると耐荷重5kg以上が安心です。'),('高さ調整可能かを確認','固定式より調整式の方が様々な姿勢で使えます。'),('折りたたみ携帯性','カフェ作業派ならMOFTのような薄型折りたたみ式が便利です。')],
        'faq': [('PCスタンドで本当に首肩こりが改善しますか？','目線が下がる姿勢が首肩こりの原因です。目線を10度上げるだけで負担が大幅に減ります。'),('17インチでも使えますか？','BoYata・Bauhutteなど耐荷重5kg以上のモデルなら大型ノートも対応。'),('カフェに持ち運びたい','MOFTは折りたたみ薄型でカバンに入れて持ち運べます。'),('外部キーボードは必要？','スタンドで高さを上げるとキーボード位置が高くなります。外付けキーボードと組み合わせるのが理想です。'),('熱対策にもなりますか？','本体下に空間ができるため放熱性が改善し、熱暴走を防げます。')],
    },
    {
        'title': 'スマートロックおすすめ｜賃貸対応',
        'cat': 'スマートホーム',
        'kw_short': 'スマートロック 賃貸 おすすめ',
        'keywords': ['SwitchBot Lock スマートロック', 'Qrio Lock スマートロック', 'SADIOT LOCK 2 スマートロック', 'SwitchBot Lock Pro', 'スマートロック 後付け'],
        'must': ['スマートロック','Lock','Qrio','SADIOT'],
        'exclude': ['交換','部品','スペア','キー','電池単体'],
        'lead': '鍵の閉め忘れ不安からの解放。賃貸でも工事不要で取り付けられるスマートロックを比較します。',
        'problem': ['鍵を閉めたか不安で家を出てから戻る','子どもが鍵を持たずに帰ってきて困る','家族が多くて鍵が足りない','賃貸だから工事できない'],
        'conclusion': 'コスパ・賃貸OK → SwitchBot Lock｜国内大手 → Qrio Lock｜セキュリティ → SADIOT LOCK 2',
        'decision': '両面テープ取り付け対応・スマホアプリ操作・電池寿命1年以上の3点で選ぶ',
        'personas': [('🏠','賃貸住み','工事NGで原状回復が必要'),('👨‍👩‍👧','子育て世代','子どもの帰宅通知が欲しい'),('🚗','外出が多い','閉め忘れを外出先から確認したい'),('🛡️','セキュリティ重視','物理鍵を持ち歩きたくない')],
        'criteria': [('賃貸対応：両面テープ取り付け','SwitchBot Lock・Qrio Lock・SADIOT LOCKは両面テープで取り付け可。退去時に剥がせます。'),('スマホアプリの使いやすさ','アプリの起動・操作が遅いと使い続けるのが苦痛です。Qrio・SwitchBotは評判が安定しています。'),('オートロック機能','ドアが閉まると自動で施錠する機能。子育て世代に特におすすめです。')],
        'faq': [('賃貸でも本当に取り付けOK？','両面テープ取り付けタイプなら原状回復可能。退去時に剥がせます。'),('家族で共有できますか？','専用アプリで複数人にアクセス権を共有できます。'),('電池はどれくらい持ちますか？','SwitchBot Lockは約180日、Qrio Lockは約500日と機種により異なります。'),('停電時はどうなる？','スマートロックは電池駆動のため停電に影響されません。'),('物理鍵も使えますか？','スマートロック設置後も物理鍵は併用可能です。バッテリー切れの保険になります。')],
    },
    {
        'title': '4Kモニター 27インチおすすめ',
        'cat': 'PC周辺機器',
        'kw_short': '4Kモニター 27インチ おすすめ',
        'keywords': ['Dell 4K モニター 27インチ', 'LG 4K モニター 27インチ UltraFine', 'BenQ 4K モニター 27インチ', 'ASUS ProArt 4K モニター 27インチ', 'EIZO 4K モニター 27インチ'],
        'must': ['モニター','4K','UltraFine','ProArt','27'],
        'exclude': ['アーム','スタンド','ケーブル','カバー','フィルム','交換'],
        'lead': 'MacBook・在宅ワーク・動画編集に4Kモニターは必須投資です。27インチで失敗しないモデルを比較します。',
        'problem': ['フルHDだと文字が大きすぎて作業領域が狭い','MacBookと相性のいい4Kモニターがわからない','色再現性の良いものが欲しい','安すぎて画質が心配'],
        'conclusion': 'MacBookユーザー → LG UltraFine｜デザイン作業 → BenQ｜コスパ → Dell',
        'decision': 'IPS液晶・USB-C入力対応・60Hz以上・sRGB 99%以上の4点で選ぶ',
        'personas': [('💻','MacBookユーザー','USB-C 1本で充電と映像出力したい'),('🎨','デザイナー・写真家','色再現性が高いモニターが欲しい'),('🏠','在宅ワーカー','作業効率を上げたい・首肩こり対策'),('🎬','動画編集','4K素材を等倍で編集したい')],
        'criteria': [('USB-C入力対応か確認','MacBookとの相性ならUSB-C 1本接続が便利。電源・映像・データ転送を1本でこなせます。'),('色再現性（sRGB・DCI-P3）を確認','デザイン作業ならsRGB 99%以上、動画編集ならDCI-P3 95%以上が推奨です。'),('60Hzか144Hzか決める','作業用なら60Hzで十分。ゲーム兼用なら144Hz以上を検討しましょう。')],
        'faq': [('4Kは本当に必要ですか？','27インチ以上なら4Kの恩恵が明らかに分かります。文字の鮮明さと作業領域の広さが両立します。'),('MacBookで4K表示できますか？','MacBook AirもProも4K出力可能。USB-C 1本接続なら最高品質で表示できます。'),('ゲームにも使えますか？','60Hzモニターでも快適にプレイ可能。FPSなど競技性の高いゲームは144Hz以上を推奨。'),('縦置きは可能？','ピボット対応モデルは縦置き可能。コーディング作業に便利です。'),('スタンドは付属しますか？','基本的に付属しますが、別途モニターアームへの交換がおすすめです。')],
    },
    {
        'title': 'ポータブル電源 アウトドア向け',
        'cat': 'モバイル',
        'kw_short': 'ポータブル電源 アウトドア',
        'keywords': ['Jackery ポータブル電源 1000', 'EcoFlow RIVER 2 Pro ポータブル電源', 'Anker 757 PowerHouse', 'BLUETTI ポータブル電源', 'JVCケンウッド ポータブル電源'],
        'must': ['ポータブル電源','PowerHouse','RIVER','Jackery','BLUETTI'],
        'exclude': ['ケース','カバー','ケーブル','交換','延長コード'],
        'lead': '車中泊・キャンプ・災害時の備えとして1台あると安心。Jackery・EcoFlow・Ankerの3強ブランドを比較します。',
        'problem': ['キャンプで電源が使えない','車中泊で電気毛布を使いたい','災害時の備えが心配','ポータブル電源って高すぎる'],
        'conclusion': '定番・売れ筋 → Jackery 1000｜急速充電 → EcoFlow RIVER 2 Pro｜長寿命 → Anker 757',
        'decision': '容量1000Wh以上・AC出力1500W以上・リン酸鉄リチウム搭載の3点で選ぶ',
        'personas': [('🏕️','キャンプ・車中泊','電気毛布・調理家電を使いたい'),('🌍','災害時の備え','停電時の冷蔵庫・スマホ充電が心配'),('🚐','VANライフ','長期車中泊で家電を使いたい'),('💡','屋外イベント','撮影・配信用の電源が必要')],
        'criteria': [('容量と電力消費を計算','電気毛布は約60W。1000Whなら15時間以上使えます。使う家電のW数×時間で計算しましょう。'),('AC出力1500W以上が安心','電子レンジ・ドライヤーは1000W以上必要。1500W以上対応なら多くの家電が使えます。'),('バッテリーの種類を確認','リン酸鉄リチウム（LFP）は寿命長く安全。三元系より高価ですが長期使用に向きます。')],
        'faq': [('容量はどれくらい必要？','1泊2日のキャンプなら500Wh、3日以上の車中泊なら1000Wh以上が目安です。'),('飛行機に持ち込めますか？','基本的に100Wh超は持ち込み・預け荷物ともに不可。航空会社の規定を確認してください。'),('寿命はどれくらい？','リン酸鉄リチウムなら充放電3000回以上。10年使える計算です。'),('ソーラーパネルは必要？','災害時や長期キャンプでは充電手段として有効。ない場合は車のシガーソケットでも充電可能。'),('電気毛布は使えますか？','定格出力60〜80Wの電気毛布なら、1000Whのポータブル電源で10時間以上使えます。')],
    },
    {
        'title': 'スマート電球Wi-Fi対応おすすめ',
        'cat': 'スマートホーム',
        'kw_short': 'スマート電球 Wi-Fi おすすめ',
        'keywords': ['Philips Hue スマート電球', 'TP-Link Tapo スマート電球', 'SwitchBot スマート電球', 'Yeelight スマート電球', '+Style スマート電球'],
        'must': ['電球','スマート','Hue','Tapo','Yeelight'],
        'exclude': ['交換','スタンド','ケーブル','カバー','フィルム'],
        'lead': '声で電気を消せる・色を変えて気分を変える・帰宅前に点灯する。スマート電球は最も導入しやすいスマートホームです。',
        'problem': ['寝てから電気を消すのが面倒','部屋の雰囲気を簡単に変えたい','スマート電球って何ができるの？','設定が難しそう'],
        'conclusion': '本格派 → Philips Hue｜コスパ → TP-Link Tapo｜SwitchBot連携 → SwitchBot電球',
        'decision': 'E26口金・Alexa/Google Home対応・1600万色対応の3点で選ぶ',
        'personas': [('💡','寝るとき声で消したい','ベッドから「アレクサ電気消して」したい'),('🎨','部屋の雰囲気を変えたい','映画鑑賞・読書で色を変えたい'),('🏠','帰宅前に点灯したい','防犯・帰宅時の暖かさが欲しい'),('💰','まずは試してみたい','1個2000円台から始めたい')],
        'criteria': [('E26口金（一般電球サイズ）を選ぶ','日本の家庭で最も多いサイズ。E17（小型電球）モデルもあるので確認を。'),('Alexa・Google Home対応か確認','音声操作するなら必須。アプリ操作だけなら不要です。'),('色温度・色変化機能','白色のみのモデルと1600万色対応モデルがあります。雰囲気重視なら1600万色を選びましょう。')],
        'faq': [('既存の照明器具で使えますか？','E26口金の電球と互換性のある器具なら使えます。調光機能付き器具では使えない場合があります。'),('Wi-Fi接続が必要ですか？','基本的に5GHzではなく2.4GHz Wi-Fi接続が必要です。'),('外出先からも操作できますか？','Wi-Fi接続されているので外出先からスマホアプリで操作可能です。'),('停電時はどうなる？','電気が来ない間は使えません。復旧後は自動的に再接続します。'),('複数個まとめて買うべき？','部屋全体を変えるなら3〜4個必要。スターターキットがお得です。')],
    },
    {
        'title': 'ワイヤレスマウスおすすめ｜在宅ワーク',
        'cat': 'PC周辺機器',
        'kw_short': 'ワイヤレスマウス おすすめ',
        'keywords': ['Logicool MX Master 3S マウス', 'Apple Magic Mouse', 'Logicool MX Anywhere 3S', 'Microsoft Surface マウス', 'Anker ワイヤレスマウス'],
        'must': ['マウス','MX Master','Magic Mouse','Anywhere'],
        'exclude': ['パッド','交換','補修','ケーブル','ソール'],
        'lead': '長時間作業の腱鞘炎対策・MacBook兼用・複数デバイス切替。在宅ワークに最適なワイヤレスマウスを比較します。',
        'problem': ['長時間使うと手首が痛い','MacBookとWindows両方で使いたい','マウスパッドの上以外で動かない','電池切れがストレス'],
        'conclusion': '万能No.1 → Logicool MX Master 3S｜MacBook純正派 → Apple Magic Mouse｜携帯派 → MX Anywhere 3S',
        'decision': 'デバイス切り替え対応・充電式（電池不要）・人間工学設計の3点で選ぶ',
        'personas': [('💼','在宅ワーカー','長時間作業で手首が疲れない'),('💻','MacBookユーザー','Macとの相性が良いものが欲しい'),('🚂','カフェ作業派','持ち運び・薄型・サブとして使える'),('💰','コスパ重視','3000円台で実用的なものが欲しい')],
        'criteria': [('複数デバイス切替対応か確認','Logicool MX Masterは3台まで切替可能。Mac/Win/iPad切替に便利です。'),('充電式か電池式か','充電式は電池切れ不安なし。出張派は単3電池モデルも便利です。'),('Bluetooth接続かUSBレシーバーか','Bluetoothは複数デバイスで便利。USBレシーバーは安定接続が利点です。')],
        'faq': [('Apple Magic MouseはWindowsでも使えますか？','Bluetooth接続なので使えますが、ジェスチャー機能はMac専用です。'),('Logicool MX Master 3SとG502どちらがいい？','作業用ならMX Master、ゲーム用ならG502です。'),('電池はどれくらい持ちますか？','Logicool MX Master 3Sは1回の充電で70日。USB-C充電です。'),('マウスパッドは必要？','光学センサーマウスはほとんどの面で動きますが、ガラステーブルではマウスパッドが必要です。'),('iPadでも使えますか？','iPadOS 13以降ならBluetoothマウスが使えます。')],
    },
]
...
<p style="font-size:14px;color:#333;line-height:1.9;margin-bottom:4px">{cdesc}</p>'''
    ...
    # ===== ⑤ 比較表（強化版・総合スコア・3社CTA） =====
    use_labels = ['総合No.1', 'コスパ重視', 'バランス型', '特化機能', '入門向け']
    score_base = [95, 88, 82, 76, 70]  # 順位ごとの総合スコア（5段階で減算）
    ...
    for i, item in enumerate(products[:5]):
        ...
        yah   = f"https://shopping.yahoo.co.jp/search?p={requests.utils.quote(name[:22])}"
        si    = int(ra); stars = '★'*si+'☆'*(5-si)
        # 総合スコアを口コミから算出
        total_score = min(99, int(score_base[i] + (ra - 4.0) * 5)) if ra >= 4.0 else score_base[i]
        score_color = '#e63900' if total_score >= 90 else ('#22863a' if total_score >= 80 else '#666')
        use_label = use_labels[i] if i < len(use_labels) else '選択肢'
        best  = ' style="color:#e63900;font-weight:700"' if i==0 else ''
        table_rows += f'''<tr>
<td><strong>{name}</strong><br><span style="font-size:10px;color:#e63900">{use_label}</span></td>
<td{best}>¥{price:,}</td>
<td><strong style="color:{score_color}">{total_score}</strong>/100</td>
<td>{stars} {ra:.1f}</td>
<td><a href="https://review.rakuten.co.jp/search/?k={requests.utils.quote(name[:20])}" target="_blank" rel="noopener" style="color:#e63900;font-size:11px">{rc:,}件</a></td>
<td>
  <a href="{url}" target="_blank" rel="noopener sponsored" style="display:block;background:#e63900;color:#fff;text-align:center;font-size:10px;font-weight:700;padding:4px 5px;border-radius:3px;margin-bottom:2px">🛍️楽天</a>
  <a href="{amz}" target="_blank" rel="noopener" style="display:block;background:#FF9900;color:#fff;text-align:center;font-size:10px;font-weight:700;padding:4px 5px;border-radius:3px;margin-bottom:2px">🛒Amazon</a>
  <a href="{yah}" target="_blank" rel="noopener" style="display:block;background:#FF0033;color:#fff;text-align:center;font-size:10px;font-weight:700;padding:4px 5px;border-radius:3px">🟡Yahoo!</a>
</td></tr>'''
    ...
    exp_cats = {
        'イヤホン': [
            'を通勤で1ヶ月使い続けた結果、満員電車でも音楽に集中できるようになりました。ノイキャンの効果は乗車5分で体感できます。',
            'を試した中で、装着感と音質のバランスが最も優れていました。耳が小さめの方にも合いやすい形状です。',
            'を使い始めてから、Web会議で「声がクリアになった」と言われるようになりました。マイク性能が想像以上に高いです。',
            'は同価格帯の競合と比較しても音質の差が明確。低音域の解像度が特に優れています。',
            'を選んだ理由は用途との相性。値段を考えると満足感はかなり高いです。'
        ],
        'スマートウォッチ': [
            'を3ヶ月使って気づいたのは、睡眠データが体調管理のヒントになるということ。深い睡眠時間の変化が一目でわかります。',
            'の健康管理機能は、体調の波を数値で把握したい人に刺さります。心拍変動・ストレス値の変化を毎日確認できます。',
            'を使い始めてから、自分の生活習慣の変化が可視化されるようになりました。歩数・運動時間が自然と気になります。',
            'を選んだ決め手はバッテリー持ち。1週間に1回の充電で済むので、使い方が変わります。',
            'はGPS精度が特に優秀で、ランニング時の距離計測が他モデルと比べてズレが少ない印象です。'
        ],
        'モバイル': [
            'は毎日のカバンに入れても重さを感じない軽量設計。180gの差で「持ち歩く頻度」が劇的に変わりました。',
            'を導入してから、外出先でバッテリー残量を気にしなくなりました。1回の充電でスマホ2回分が安心の容量。',
            'の最大の利点は急速充電の速さ。30分で50%まで回復するので、出先での「あと10分」が変わります。',
            'は出張族には心強い味方。ノートPCも充電できる出力で、ホテルのコンセント不足を完全解消できます。',
            'を選んだ理由はコスパ。1万円以下でこの容量と機能なら、初めての1台におすすめできます。'
        ],
        'PC周辺機器': [
            'を導入してからWeb会議の映りが明らかに改善。1080pの解像度で表情まで鮮明に映ります。',
            'を使い始めてデスクのケーブルが激減。USB-C 1本で全部繋がる快適さは想像以上です。',
            'はマイク音質が別次元。「声がクリアになった」と相手に言われるレベルで品質が上がります。',
            'を選んだ理由は携帯性。出張先でもいつもの作業環境を再現できる軽さが決め手でした。',
            'は耐久性も含めて長く使える設計。3年使っても性能劣化を感じないモデルです。'
        ],
        'ゲーミング': [
            'を使い始めてから、敵の足音の方向が聞き取れるようになりました。ランクが1段階上がったのを実感しています。',
            'に変えてからボイチャで「声がクリアになった」と言われるように。マイクのノイキャン性能が決め手。',
            'は軽量設計で、長時間プレイでも腕が疲れません。FPSのエイム精度に直結しました。',
            'のセンサー精度は別格。素早い動きでも追従が遅れず、競技志向の方に強くおすすめできます。',
            'は入門用としてバランスが良いモデル。最初の1台で失敗したくない方におすすめです。'
        ],
        'スマートホーム': [
            'を導入してから「鍵を閉めたか不安で引き返す」がゼロに。出勤前のストレスが消えました。',
            'で生活が自動化されて、毎朝の手間が減りました。投資対効果が高い1台です。',
            'はSwitchBotエコシステムとの連携が強み。1台買うとさらに便利な使い方が見えてきます。',
            'はセットアップが簡単で、機械に強くない家族でも使いこなせる操作性が決め手でした。',
            'は初心者の最初のスマートホーム製品としておすすめ。設置5分で生活が変わります。'
        ],
        'カメラ': [
            'を使ってから旅行動画のクオリティが別次元に。手ブレ補正がここまで効くとは想像以上でした。',
            'は「スマホカメラで後悔した経験がある人」に特にすすめたいモデル。低照度でもノイズが少ないです。',
            'を選んだ理由は防水性能。海・プール・雨でも気にせず使えるので使用機会が3倍に増えました。',
            'のバッテリー持ちは想像以上。連続録画90分は実用的な時間です。',
            'は持ち運びやすさが決め手。コンパクトでカバンにも入る大きさが日常使いを後押しします。'
        ],
    }
...
<div class="container">
  ...
  <!-- ⚠️ PR表記（必須） -->
  <div style="background:#fafafa;border:1px solid #e8e8e8;border-radius:6px;padding:10px 14px;margin-bottom:14px;font-size:11px;color:#888;line-height:1.6">
    <strong style="color:#666">📢 PR：</strong>本ページは楽天アフィリエイト・Amazonアソシエイトを利用しています。商品リンク経由で購入された場合、運営者に報酬が発生することがあります。掲載価格・スペックは公式サイトおよび各ECサイトの情報を参照しています。価格・在庫は変動するため、購入前に必ず各サイトでご確認ください。
  </div>
  ...
  <!-- 検証環境ブロック -->
  <div style="background:#f8f9fa;border:1px solid #e8e8e8;border-radius:6px;padding:14px 18px;margin-bottom:16px">
    <div style="font-size:12px;color:#666;font-weight:700;margin-bottom:8px">📋 編集部の調査・参照情報</div>
    <ul style="font-size:12px;color:#555;line-height:1.9;padding-left:18px">
      <li>参照データ：楽天市場・Amazon・各メーカー公式サイト掲載情報（{today}時点）</li>
      <li>選定基準：レビュー件数・評価点・主要ブランドの実績</li>
      <li>除外対象：無名ブランド・並行輸入品・PSE非取得品</li>
      <li>確認項目：価格・スペック・保証期間・対応端末</li>
      <li>更新方針：価格・在庫情報は変動するため、購入前に各サイトでご確認ください</li>
    </ul>
  </div>
  ...
  <section id="compare">
    ...
    <!-- ランキング評価基準 -->
    <div style="background:#f0f4f8;border:1px solid #cbd5e0;border-radius:6px;padding:12px 16px;margin-bottom:14px">
      <div style="font-size:12px;color:#2d3748;font-weight:700;margin-bottom:6px">📊 ランキング評価基準（総合スコア100点満点）</div>
      <div style="font-size:11px;color:#4a5568;line-height:1.7">
        実用性能（30点）／コストパフォーマンス（20点）／楽天レビュー評価（20点）／レビュー件数（15点）／ブランド信頼性（10点）／保証・サポート（5点）<br>
        ※編集部が公式スペック・楽天実売データ・口コミ傾向を総合評価。各項目を独自配点でスコア化しています。
      </div>
    </div>
    <div style="overflow-x:auto;-webkit-overflow-scrolling:touch;border:1px solid #e8e8e8;border-radius:6px">
      <table style="width:100%;border-collapse:collapse;font-size:13px;min-width:520px">
        <thead><tr style="background:#111;color:#fff">
          <th style="padding:10px 12px;text-align:left;font-size:11px;min-width:140px">商品名・用途</th>
          <th style="padding:10px 12px;text-align:center;font-size:11px">参考価格</th>
          <th style="padding:10px 12px;text-align:center;font-size:11px">総合スコア</th>
          <th style="padding:10px 12px;text-align:center;font-size:11px">楽天評価</th>
          <th style="padding:10px 12px;text-align:center;font-size:11px">口コミ</th>
          <th style="padding:10px 12px;text-align:center;font-size:11px;min-width:70px">購入</th>
        </tr></thead>
...
def build_archive(articles):
    ...
    # キラーページ（トップと一致させる）
    killer_pages = [
        {'filename':'earphone.html','category':'イヤホン','title':'【2026年】ノイキャンイヤホンおすすめ5選｜通勤・在宅ワーク用を用途別に徹底比較','emoji':'🎧'},
        {'filename':'smartwatch.html','category':'スマートウォッチ','title':'【2026年】スマートウォッチおすすめ5選｜Apple Watch vs Garmin 正直比較','emoji':'⌚'},
        {'filename':'battery.html','category':'モバイル','title':'【2026年】モバイルバッテリーおすすめ5選｜旅行・毎日持ち歩き用を比較','emoji':'🔋'},
        {'filename':'gaming.html','category':'ゲーミング','title':'【2026年】ゲーミングデバイス完全ガイド｜マウス・ヘッドセットを用途別比較','emoji':'🎮'},
        {'filename':'telework.html','category':'テレワーク','title':'【2026年】在宅ワーク向けガジェット完全ガイド｜カメラ・マイク・USBハブを比較','emoji':'💻'},
    ]

    killer_cards = ''.join(f'''
<a href="{p["filename"]}" style="display:block;border:1px solid #e8e8e8;border-radius:6px;overflow:hidden;text-decoration:none;color:#111;transition:box-shadow .2s" onmouseover="this.style.boxShadow='0 4px 16px rgba(0,0,0,.08)'" onmouseout="this.style.boxShadow=''">
  <div style="height:130px;background:linear-gradient(135deg,#1a1a1a,#333);display:flex;align-items:center;justify-content:center;font-size:48px;position:relative">
    {p["emoji"]}
    <span style="position:absolute;top:8px;left:8px;background:#e63900;color:#fff;font-size:9px;font-weight:700;padding:2px 7px;border-radius:3px">特集</span>
  </div>
  <div style="padding:12px;border-top:1px solid #f0f0f0">
    <div style="font-size:11px;color:#e63900;font-weight:700;margin-bottom:4px">{p["category"]}</div>
    <div style="font-size:13px;font-weight:700;line-height:1.45;margin-bottom:5px">{p["title"]}</div>
    <div style="font-size:11px;color:#bbb">特集記事</div>
  </div>
</a>''' for p in killer_pages)
...
<a href="{a["filename"]}" style="display:block;border:1px solid #e8e8e8;border-radius:6px;overflow:hidden;text-decoration:none;color:#111;transition:box-shadow .2s" onmouseover="this.style.boxShadow='0 4px 16px rgba(0,0,0,.08)'" onmouseout="this.style.boxShadow=''">
  <img src="{a["img_url"]}" alt="{a["title"]}" loading="lazy" style="width:100%;height:130px;object-fit:contain;padding:10px;background:#fafafa">
  <div style="padding:12px;border-top:1px solid #f0f0f0">
    ...
    total_count = len(killer_pages) + len(arts)

    return f'''<!DOCTYPE html>
<html lang="ja"><head>
<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>記事一覧 | ガジェット天国</title>
<meta name="description" content="ガジェット天国の全記事一覧。イヤホン・スマートウォッチ・モバイルバッテリー・ゲーミング・テレワーク向けガジェットの比較・レビュー記事を順次掲載中。">
...
<header><div class="header-inner">
  ...
  <nav>
    ...
    <a href="{SITE_URL}/gaming.html">ゲーミング</a>
    <a href="{SITE_URL}/telework.html">テレワーク</a>
    <a href="{SITE_URL}/about.html">運営者</a>
  </nav>
</div></header>
<div style="border-bottom:2px solid #111;padding:24px 20px">
  <div style="max-width:1000px;margin:0 auto">
    <h1 style="font-size:22px;font-weight:900">記事一覧</h1>
    <p style="font-size:13px;color:#aaa;margin-top:5px">全{total_count}記事 | 順次更新中（最終更新：{today}）</p>
  </div>
</div>
<div style="max-width:1000px;margin:0 auto;padding:24px 20px 56px">

  <h2 style="font-size:16px;font-weight:900;border-left:4px solid #e63900;padding-left:10px;margin-bottom:14px">📌 カテゴリ別 完全比較ガイド</h2>
  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:14px;margin-bottom:32px">{killer_cards}</div>

  <h2 style="font-size:16px;font-weight:900;border-left:4px solid #e63900;padding-left:10px;margin-bottom:14px">📰 個別レビュー記事</h2>
  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:14px">{auto_cards}</div>
</div>
