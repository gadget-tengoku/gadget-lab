...
ALL_THEMES = [
    {
        ...
        'keywords': [
            ...
            'Jabra Elite ワイヤレスイヤホン',
            'Anker Soundcore Liberty NC イヤホン',
        ...
        'conclusion': 'ノイキャン最強 → Sony WF-1000XM5、コスパ重視 → Anker Soundcore、Web会議特化 → Jabra',
        'decision': '「ノイキャン性能」より「用途」で選ぶ。マイク品質と連続使用時間の2点も必ず確認する',
        'personas': [
            ('🚃', '毎日電車通勤', '騒音を完全遮断して音楽・ポッドキャストを楽しみたい', 'Sony WF-1000XM5'),
            ('💻', '在宅ワーク・Web会議', '家族の声を遮断しつつマイクの音声も鮮明にしたい', 'Jabra Elite'),
            ('💰', '初めての購入・コスパ重視', '1万円台で本格ノイキャンを体験したい', 'Anker Soundcore'),
            ('🏃', '運動しながら使う', '外音も聞こえて安全に・耳も疲れない', 'Shokz OpenRun'),
        ],
        'criteria': [
            ...
            ('連続使用時間は「本体のみ」で確認する', '「最大32時間」はケース込みの数字。本体単体での連続使用が重要。通勤往復2時間なら本体4時間でOK。在宅なら8時間以上を選びましょう。'),
        ],
        'faq': [
            ('ノイキャンイヤホンは飛行機でも効果がありますか？', '非常に効果的です。飛行機のエンジン音は低周波なのでノイキャンが最も得意とする帯域です。長距離フライトに必携です。'),
            ('在宅ワークのWeb会議でマイクは使えますか？', '機種によって大きく差があります。Jabra・Sony・Anker上位モデルは通話品質が高く評価されています。安価なモデルはマイクが弱い傾向があります。'),
            ('1万円台と3万円台の違いは何ですか？', '日常の騒音（カフェ・図書館レベル）なら1万円台で十分。電車・飛行機の騒音を本当に消したいなら3万円台のSonyかBoseを選んでください。効果量が全然違います。'),
            ('長時間装着すると耳が痛くなります', 'まずイヤーピースのサイズを変えてください（S/M/L）。それでも痛い場合はShokz（骨伝導）への変更を検討してください。耳の穴に何も入れないので長時間でも痛くなりません。'),
            ('iPhoneとAndroid両方で使えますか？', 'Bluetooth接続なのでOS問わず使用可。ただし専用アプリのノイキャン調整機能はiOSの方が充実しているケースがあります。'),
        ],
    },
    {
        ...
        'cat':     'イヤホン',
        'keywords': [
            'Jabra Elite Active ワイヤレスイヤホン スポーツ',
            'Shokz OpenRun スポーツ イヤホン',
            'Anker Soundcore Sport イヤホン 防水',
            'Sony LinkBuds Sport',
            'JVC スポーツ イヤホン 防水',
        ],
        'must':    ['イヤホン'],
        ...
        'conclusion': '落ちない固定力 → Jabra Elite Active、耳をふさがない安全性 → Shokz、コスパ → Anker Sport',
        'decision': 'IPX4以上の防水・固定方法（イヤーフック/ウイングチップ）・外音取り込み機能の3点で絞り込む',
        'personas': [
            ...
            ('💰', '初めてのスポーツ用', '3000円台から試してみたい', 'JVC スポーツモデル'),
        ],
        'criteria': [
        ...
        'faq': [
            ...
            ('防水のイヤホンは音も良いですか？', '最近は音質と防水を両立したモデルが増えています。Sony LinkBuds Sportは音質とスポーツ性能を両立しています。'),
            ('バッテリーはどれくらいもちますか？', '本体6〜10時間が目安。フルマラソン（4〜5時間）も余裕でカバーできます。'),
    ...
    },
    {
        ...
        'cat':     'スマートウォッチ',
        'keywords': [
            'Garmin Venu スマートウォッチ',
            'Apple Watch SE 本体',
            'Samsung Galaxy Watch 本体',
            'Fitbit スマートウォッチ',
            'Withings スマートウォッチ 健康',
        ],
        'must':    ['スマートウォッチ','ウォッチ','Watch'],
        'exclude': ['バンド','ベルト','充電','ケース','フィルム','交換','スタンド','充電器'],
        'lead':    '睡眠・心拍・血中酸素・ストレスを毎日記録して、自分の体の変化を数値で把握したい方向けです。',
        'problem': ['体調が悪い日の原因がわからない', '睡眠の質を改善したいが何をすればいいかわからない', '血圧・心拍が気になるが病院に行くほどじゃない', 'Apple WatchとGarminどっちがいいか決められない'],
        'conclusion': 'バッテリー・GPS重視 → Garmin、iPhoneユーザーの入門 → Apple Watch SE、コスパ → Fitbit',
        'decision': 'バッテリー持ち・GPS精度・健康データの詳細さで選ぶ。Garminは5日以上、Apple Watchは毎日充電前提',
        'personas': [
            ('❤️', '健康診断で引っかかった40代', '血圧・心拍・睡眠を毎日数値で把握したい', 'Garmin Venu'),
            ('🏅', 'ランニング・マラソン', 'GPS精度・ルート記録・トレーニング分析', 'Garmin Forerunner'),
            ('📱', 'iPhoneユーザーの入門', 'Apple Watchを試してみたい・使いやすさ重視', 'Apple Watch SE'),
            ('💼', 'ビジネスマン', '通知管理・見た目がスーツに合う', 'Samsung Galaxy Watch'),
        ],
        'criteria': [
            ('バッテリー持ちで選ぶ', 'Apple Watchは1〜2日で要充電。GarminのVenuは5〜7日持つ。毎日充電が面倒な人はGarminを選んでください。'),
            ('健康データの詳細さで選ぶ', '睡眠ステージ・ストレス・血中酸素・体温変化など詳細を見たいならGarminが圧倒的。Apple Watchは心電図が強み。'),
            ('iPhoneかAndroidかで選ぶ', 'Apple WatchはiPhone専用。AndroidユーザーはGarmin・Samsung・Fitbitから選んでください。'),
        ],
        'faq': [
            ('血圧は正確に測れますか？', '医療機器ではないため参考値です。傾向把握・異常値アラートとして十分活用できます。'),
            ('Apple WatchとGarminどっちがいいですか？', 'iPhoneユーザーで決済機能も使いたいならApple Watch。バッテリー持ち・GPS精度・健康データの詳細さを重視するならGarmin。'),
            ('睡眠の質はどうやって計測しますか？', '心拍数・血中酸素・体動から睡眠ステージ（深い/浅い/REM）を自動判定します。'),
            ('防水性能はありますか？', 'ほとんどのモデルが5ATM防水でシャワーや水泳にも対応しています。'),
            ('バッテリーはどれくらいもちますか？', 'Apple Watchは1〜2日、GarminのVenuは5〜7日、FitbitのCharge系は7〜10日が目安です。'),
        ],
    },
    {
        ...
        'cat':     'モバイル',
        'keywords': [
            'Anker PowerCore モバイルバッテリー 10000mAh',
            'CIO モバイルバッテリー 薄型',
            'Anker PowerCore 20000 大容量',
            'Belkin モバイルバッテリー',
            'Anker Nano モバイルバッテリー 軽量',
        ],
        'must':    ['バッテリー','モバイル'],
        'exclude': ['ケース','カバー'],
        'lead':    '「重いから持ち歩くのをやめた」という人向けに、毎日使い続けられる軽量モデルから大容量モデルまで厳選しました。',
        'problem': ['重くて持ち歩くのが面倒でカバンに入れなくなった', '旅行中にスマホとノートPCの両方を充電したい', '5000円以下で買えるコスパの良いモデルがわからない', '飛行機に持ち込める容量の上限がわからない'],
        'conclusion': '毎日持ち歩き → Anker Nano（軽量）、旅行・出張 → Anker PowerCore 20000、コスパ → CIO',
        'decision': '用途によって「容量」と「重さ」のバランスを変える。毎日は200g以下・旅行は容量優先',
        'personas': [
            ('👔', '毎日通勤するビジネスマン', 'カバンに入れても重くない・スマホ1回分あればOK', 'Anker Nano 10000'),
            ('✈️', '出張・旅行が月2回以上', 'ノートPCも充電できる・飛行機OK・3日持つ', 'Anker PowerCore 20000'),
            ('💰', 'とにかく安く', '3000円台で買えるコスパ重視', 'Anker 5000mAh'),
            ('📱', 'スマホ2台持ち', '2台同時充電できるポートが多いモデル', 'CIO 2ポートモデル'),
        ],
        'criteria': [
            ...
            ('飛行機持ち込みは100Wh以下（約27000mAh）', '多くの20000mAhモデルは96〜99Wh設計で持ち込みOK。必ず購入前にWh表記を確認しましょう。'),
        ],
        'faq': [
            ('毎日持ち歩くなら何mAhがいいですか？', 'スマホ1回分なら5000〜10000mAh。200g以下を選べば重さを感じません。'),
            ('急速充電対応かどうかの確認方法は？', 'PD（Power Delivery）18W以上と書かれているものが急速充電対応です。'),
            ('ノートPCも充電できますか？', '65W以上のPD出力対応ならMacBook Airも充電できます。MacBook Pro 16インチは140W必要。'),
    ...
    },
    {
        ...
        'cat':     'PC周辺機器',
        'keywords': [
            'Logicool ウェブカメラ C920 フルHD',
            'Anker USBハブ Type-C MacBook',
            'Logicool ゲーミングキーボード テレワーク',
            'Blue Yeti USB マイク',
            'Anker GaN充電器 65W MacBook',
        ],
        'must':    ['カメラ','ハブ','キーボード','マイク','充電器'],
        'exclude': ['ケーブル','交換','パーツ','カバー'],
        'lead':    '在宅ワーク歴3年が「本当に買って良かった」と思うガジェットを正直に紹介します。',
        'problem': ['Web会議でカメラの画質が悪くて映りが気になる', 'MacBookのポートが足りなくてドングルだらけ', 'デスクのケーブルが多すぎてぐちゃぐちゃ', 'キーボードの打鍵感が悪くて作業効率が下がっている'],
        'conclusion': 'Web会議の映り → Logicool C920、ポート不足 → Anker USBハブ、マイク音質 → Blue Yeti',
        'decision': '在宅ワーク環境は「カメラ→マイク→ハブ」の順番で投資すると費用対効果が高い',
        'personas': [
            ('📹', 'Web会議が多いビジネスマン', 'カメラの映りを改善して印象を良くしたい', 'Logicool C920s'),
            ('💻', 'MacBookユーザー', 'ポート不足を解消してすっきりしたデスクにしたい', 'Anker USBハブ 7in1'),
            ('🎙️', '配信・ポッドキャスト', 'マイクの音質をプロレベルに上げたい', 'Blue Yeti USB'),
        ...
        'faq': [
            ...
            ('ノートPCスタンドとの組み合わせは？', 'スタンドでPCを目線の高さに上げるとWeb会議の映りが劇的に改善。スタンド＋外部モニターが理想的です。'),
    ...
    },
    {
        ...
        'cat':     'ゲーミング',
        'keywords': [
            'SteelSeries Arctis Nova ゲーミングヘッドセット 本体',
        ...
        'conclusion': 'FPS足音把握 → SteelSeries Arctis Nova、マイク音質 → HyperX Cloud、コスパ → Corsair HS65',
        'decision': 'サラウンド対応・マイク品質・重量（300g以下）の3点で選ぶ',
        'personas': [
            ('🎯', 'FPS・TPS重視', '敵の足音・銃声の方向を正確に聞き取りたい', 'SteelSeries Arctis Nova'),
            ('🎙️', 'ボイチャ重視', '声が鮮明に届くマイク品質が最重要', 'HyperX Cloud III'),
            ('💰', 'コスパ重視・入門', '初めてゲーミングヘッドセットを買う', 'Corsair HS65'),
            ('📡', '無線でスッキリ', 'ケーブルなしで自由に動きたい', 'Logicool G733'),
        ],
        'criteria': [
            ('7.1chサラウンドの必要性を考える', 'FPSなら足音の方向把握に有効。ただしステレオでも高品質なモデルなら十分。まずはステレオ対応から試すのもアリです。'),
            ('マイクのノイキャン性能を確認する', '安いモデルはマイクが弱く、ゲーム音・キーボード音を拾います。SteelSeriesとHyperXはマイク品質が特に評価されています。'),
            ('重量は300g以下を選ぶ', '300g超えると長時間プレイで首が疲れます。ゲーミングチェアと組み合わせても軽いモデルがベストです。'),
        ],
        'faq': [
            ('ゲーミングヘッドセットと普通のヘッドホンの違いは？', 'マイク内蔵・サラウンド対応・ゲーム向けチューニングが主な違い。ゲームと通話を1台でこなせます。'),
            ('PS5やSwitchでも使えますか？', '3.5mmジャック・USB接続対応モデルならほとんどのゲーム機で使用可。'),
            ('有線と無線どちらがいいですか？', '遅延を極限まで減らしたいなら有線。最新の無線モデルは遅延がほぼなく実用上の差はありません。'),
            ('長時間プレイで頭が痛くなります', 'ヘッドバンドの締め付け調整と、柔らかいイヤーパッドのモデルを選んでください。'),
            ('マイクがPC・PS5に対応しているか確認方法は？', '接続方式（USB/3.5mm）を確認。PS5はUSBとBluetoothに対応。Switchは3.5mm専用です。'),
        ],
    },
    {
        ...
        'keywords': [
            ...
            'Ecovacs DEEBOT ロボット掃除機 マッピング',
            'Roborock ロボット掃除機 水拭き',
            'Panasonic ロボット掃除機',
            'SwitchBot ロボット掃除機',
        ],
        'must':    ['ロボット','掃除機'],
        ...
        'conclusion': 'ペット毛 → iRobot Roomba j7、水拭き同時 → Roborock、コスパ → Ecovacs DEEBOT',
        ...
        'personas': [
            ...
            ('💰', '初めてのロボット掃除機', '3万円台から試してみたい', 'Ecovacs DEEBOT N8'),
            ('👶', '子どもがいる家庭', '細かいゴミ・食べこぼしを毎日自動で', 'SwitchBot ロボット掃除機'),
        ],
        'criteria': [
            ('マッピング機能：間取りが複雑なら必須', '間取りをスキャンして最短ルートで掃除。複数部屋がある家庭には必須機能です。'),
            ('ゴミ自動収集：週1の掃除が月1になる', 'ダストステーションがあれば本体のゴミ捨ては月1回程度でOK。共働き家庭に特におすすめ。'),
            ('ペット毛対応：ブラシの種類を確認', 'ゴム製ブラシはペットの毛が絡まりにくい設計。毛が多い家庭はiRobot Roomba j7+一択です。'),
        ],
        'faq': [
            ('部屋が散らかっていても使えますか？', 'ケーブルや小さなおもちゃは事前に片付けが必要。それ以外は自動で避けながら掃除してくれます。'),
            ('うるさいですか？', '50〜65dBが目安。外出中に動かすのが理想ですが、最新モデルは静音性が上がっています。'),
            ('ペットの毛は吸えますか？', 'iRobot Roomba j7はペット毛に特化した設計。ゴム製ブラシで絡まりを防いでいます。'),
            ('Wi-FiやアプリなしでもOKですか？', 'アプリなしでもボタン1つで動きます。ただしスケジュール設定や掃除マップの確認にはアプリが必要です。'),
            ('水拭き対応モデルはどれがいいですか？', 'Roborock S7シリーズは吸引＋水拭きを同時に行い、カーペットを自動で避ける機能も搭載しています。'),
        ],
    },
    {
        ...
        'cat':     'スマートホーム',
        'keywords': [
            'SwitchBot スマートロック 本体',
            'Philips Hue スマート電球 LED',
            'SwitchBot ハブ スマートホーム',
            'Amazon Echo スマートスピーカー',
            'SwitchBot カーテン 自動',
        ],
        'must':    ['スマート','ロック','電球','ハブ','スピーカー','カーテン'],
        'exclude': ['交換','部品','キー','スペア','ケーブル'],
        ...
        'conclusion': 'まず試すなら → SwitchBot Hub Mini（全デバイスの司令塔）、鍵の閉め忘れ対策 → SwitchBot Lock',
        'decision': 'スマートホームは「SwitchBot Hub Mini」から始めるのが最短ルート。工事不要・賃貸OK',
        'personas': [
            ('🔑', '鍵の閉め忘れが不安', '外出先からスマホで鍵の確認・施錠がしたい', 'SwitchBot Lock'),
            ('💡', '帰宅時の電気が面倒', '玄関を開けたら自動で電気がつくようにしたい', 'Philips Hue + SwitchBot Hub'),
            ('🎙️', '声で家電を操作したい', 'Amazon EchoでエアコンやTVを音声操作', 'Amazon Echo + SwitchBot'),
            ('🌅', '毎朝カーテンを自動で開けたい', '起床時間に合わせてカーテンが自動開閉', 'SwitchBot カーテン'),
        ],
        'criteria': [
            ('まずSwitchBot Hub Miniを買う', 'すべてのSwitchBot製品をWi-Fi経由でスマホから操作できるようになる「司令塔」。これがないと外出先からの操作ができません。'),
            ('賃貸対応：取り付け工事が不要かを確認', 'SwitchBot製品は両面テープ・挟み込みが基本。退去時も原状回復できます。管理会社への届け出も不要なケースがほとんど。'),
            ('Amazon Echo（Alexa）との連携を検討する', 'SwitchBotとAlexaを連携させると「アレクサ、電気消して」の音声操作が実現。スマートホームの便利さが一気に上がります。'),
        ],
        'faq': [
            ('賃貸に取り付けても問題ありませんか？', '両面テープで取り付けるため原状回復が可能。退去時に取り外しできます。'),
            ('Wi-Fiがなくても動きますか？', 'Bluetooth接続ならWi-Fiなしでも動作可。ただし外出先からの遠隔操作にはHub Miniが必要です。'),
            ('スマートホームにするのに費用はいくらかかりますか？', 'SwitchBot Lockのみなら約1万円から。Hub Mini込みでも2万円以下でスタートできます。'),
            ('停電したらスマートロックはどうなりますか？', 'バッテリー式なので停電に影響されません。ただしバッテリー切れには注意が必要です。'),
            ('iPhoneとAndroid両方に対応していますか？', 'SwitchBot・Philips Hue・Amazon Echoはいずれもアプリがあり、iOSとAndroid両方に対応しています。'),
        ],
    },
    {
        ...
        'cat':     'カメラ',
        'keywords': [
            'GoPro HERO 12 アクションカメラ 本体',
            'DJI Osmo Action 4 アクションカメラ 本体',
            'Insta360 アクションカメラ 本体',
            'Sony アクションカメラ FDR',
            'DJI Pocket 3 カメラ',
        ],
        'must':    ['カメラ','アクション','Camera'],
        'exclude': ['ケース','マウント','バッテリー','充電','交換','アクセサリー','ハウジング'],
        'lead':    'スマホカメラでは撮れない映像をGoPro・DJIで撮った経験をもとに、正直比較します。',
        'problem': ['スマホで撮ると手ブレがひどくて見ていられない', 'GoProとDJIどっちがいいかわからない', 'アウトドアで水没・落下させたことがある', '旅行動画をSNSに上げたいが素人っぽく見える'],
        ...
        'criteria': [
            ...
            ('手ブレ補正は全モデル必須', '最新モデルはほぼすべて電子式手ブレ補正搭載。ただしDJIのRockSteady補正はGoPro Hypersmoothing比でも映像が滑らかです。'),
        ...
        'faq': [
            ...
            ('スマホのカメラとどう違いますか？', '手ブレ補正・超広角・耐衝撃・防水が最大の違い。動きのある場面での安定性が圧倒的に違います。'),
    ...
    },
    {
        ...
        'cat':     'モバイル',
        'keywords': [
            'Anker GaN充電器 65W コンパクト 本体',
            'CIO GaN充電器 65W',
            'Belkin GaN充電器',
            'Anker 120W GaN 充電器',
            'Anker Nano GaN 充電器 30W',
        ],
        'must':    ['充電器','GaN'],
        'exclude': ['ケーブル','カバー','アダプタ'],
        ...
        'conclusion': 'MacBookメイン → Anker 65W GaN、複数デバイス同時 → Anker 120W、コスパ → CIO 65W',
        'decision': '何を充電するかで選ぶW数が決まる。MacBook Air = 65W、MacBook Pro 16 = 140W、スマホのみ = 30W',
        'personas': [
            ('💻', 'MacBook Air ユーザー', '1つの充電器でMacとiPhoneを同時充電', 'Anker 65W GaN 2ポート'),
            ('🖥️', 'MacBook Pro 16 ユーザー', '高出力でMacを急速充電', 'Anker 140W GaN'),
            ('📱', 'スマホ・タブレットのみ', '小さい・軽い・旅行に最適', 'Anker Nano 30W'),
            ('🧳', '海外旅行が多い', '100-240V対応・変圧器不要', 'Anker 65W トラベル対応'),
        ],
        'criteria': [
            ('必要なW数は「最大消費電力の機器」で決まる', 'MacBook Air 15インチは70W、iPhone急速充電は25W。同時使用するなら合計W数を計算しましょう。'),
            ('複数ポートで同時充電すると出力が下がる', '65W 2ポートモデルで2台同時充電すると各ポートが33W程度に。仕様書の「同時使用時出力」を確認しましょう。'),
            ('海外対応（100-240V）かどうかを確認', '対応モデルなら変圧器不要で世界中で使えます。ほとんどのAnker・CIOモデルは対応しています。'),
        ],
        'faq': [
...
def fetch_diverse_products(theme, need=5):
    ...
    for kw in keywords:
        ...
        for item in items:
            ...
            if not is_trusted(item): continue
            if not is_clean(item, theme): continue
            seen_names.add(key)
            all_items.append(item)
            if len(all_items) >= need: break
        if len(all_items) >= need: break
        time.sleep(0.8)
