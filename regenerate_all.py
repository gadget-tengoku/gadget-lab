...
ARTICLES = [
    {"filename": "article-1万円以下コスパ最強ワイヤレスイヤホン-am-20260506.html", "title": "1万円以下コスパ最強ワイヤレスイヤホン｜在宅ワーカーの第1候補", "category": "earphone_wireless", "keyword": "ワイヤレスイヤホン", "subtheme": "コスパ", "lead": "毎日のWeb会議用に1万円以下で買えるワイヤレスイヤホンを楽天実売データから絞り込みました。マイク品質とノイキャンの実力を、レビュー件数×評価で重み付け。"},
    {"filename": "article-4Kモニター-27インチおすすめ-pm-20260509.html", "title": "4Kモニター 27インチおすすめ｜在宅作業の解像度問題を解決", "category": "monitor_4k", "keyword": "4Kモニター 27インチ", "subtheme": "在宅作業", "lead": "在宅ワーカーの生産性を底上げする27インチ4Kモニター。USB-C 1本接続・HDR・IPSパネルなど、実用視点で選びました。"},
    {"filename": "article-Apple-Watch-SE-と-Series-9-am-20260510.html", "title": "Apple Watch SE と Series 9 比較ガイド｜在宅で買うならどっち", "category": "smartwatch", "keyword": "Apple Watch", "subtheme": "Apple", "lead": "Apple Watchを買うなら SE と Series 9 どちらか。在宅ワーカー視点では「血中酸素」「心電図」が必要かどうかで答えが変わります。"},
    {"filename": "article-GaN充電器でデスクをスッキリ整理-pm-20260513.html", "title": "GaN充電器おすすめ｜在宅デスクのケーブルをスッキリ整理", "category": "mobile_battery", "keyword": "GaN充電器 USB-C", "subtheme": "在宅環境", "lead": "GaN(窒化ガリウム)採用で小型・高出力な充電器。ノートPCとスマホを1台でまかなえる、在宅デスクのケーブル整理に効くモデルを選びました。"},
    {"filename": "article-USBマイクおすすめ比較-配信-テレワーク向け--pm-20260506.html", "title": "USBマイクおすすめ比較【配信・テレワーク向け】", "category": "usb_microphone", "keyword": "USBマイク", "subtheme": "Web会議", "lead": "Web会議で「相手が聞きやすい声」になる単一指向性USBマイク。配信用にも使える音質を確保しつつ、在宅で使いやすいモデルを選びました。"},
    {"filename": "article-iPhone-15対応USB-Cイヤホン-am-20260509.html", "title": "iPhone 15対応USB-Cイヤホン｜Web会議で直挿しできる1本", "category": "earphone_wireless", "keyword": "USB-Cイヤホン", "subtheme": "iPhone", "lead": "iPhone 15シリーズのUSB-Cポートに直挿しできるイヤホン。Bluetooth不要・遅延ゼロで在宅Web会議に最適です。"},
    {"filename": "article-iPhone-15用-MagSafe充電器-am-20260513.html", "title": "iPhone 15用 MagSafe充電器おすすめ｜在宅デスクの定位置充電に", "category": "mobile_battery", "keyword": "MagSafe 充電器 iPhone", "subtheme": "在宅環境", "lead": "iPhone 15をデスクに置くだけで充電できるMagSafe充電器。在宅ワーク中の「ながら充電」に便利なスタンド型・パッド型を比較しました。"},
    {"filename": "article-ウェブカメラおすすめ比較-pm-20260507.html", "title": "ウェブカメラおすすめ比較｜Web会議の映りを底上げする", "category": "webcam", "keyword": "ウェブカメラ", "subtheme": "Web会議", "lead": "Web会議での「映りの悪さ」はカメラ買い替えで7割解決します。オートフォーカス・光量補正・解像度の3軸で選びました。"},
    {"filename": "article-ゲーミングヘッドセット完全比較-am-20260430.html", "title": "ゲーミングヘッドセット完全比較｜Web会議転用も視野に", "category": "headset", "keyword": "ゲーミングヘッドセット", "subtheme": "Web会議転用", "lead": "ゲーミングヘッドセットは実は在宅ワーカーのWeb会議用にこそ刺さります。業務用より安く、マイクは優秀。両用できる1台を選びました。"},
    {"filename": "article-ゲーミングメカニカルキーボード比較-pm-20260512.html", "title": "メカニカルキーボード比較｜在宅ワークで使うなら静音軸", "category": "wireless_mouse", "keyword": "メカニカルキーボード 静音", "subtheme": "在宅環境", "lead": "打鍵感のいいメカニカルキーボードを在宅ワーク視点で比較。Web会議に打鍵音が乗りにくい静音軸(赤軸・茶軸)を中心に選びました。"},
    {"filename": "article-スマートウォッチ初心者の選び方ガイド-am-20260504.html", "title": "スマートウォッチ初心者の選び方ガイド｜失敗しない5つの判断軸", "category": "smartwatch", "keyword": "スマートウォッチ", "subtheme": "入門", "lead": "初めてのスマートウォッチで失敗しない5つの判断軸を解説。座りすぎ通知・心拍計測・睡眠分析・スマホ連携の優先順位を整理します。"},
    {"filename": "article-テレワーク-在宅ワーク向けガジェット-pm-20260508.html", "title": "テレワーク・在宅ワーク向けガジェット完全ガイド", "category": "wireless_mouse", "keyword": "テレワーク ガジェット", "subtheme": "総合", "lead": "在宅ワーク環境を底上げする周辺機器を、優先順位の高い順に整理します。マウス・キーボード・モニター・スタンドの順で揃えるのが王道。"},
    {"filename": "article-テレワーク-在宅ワーク向けヘッドセット-am-20260508.html", "title": "テレワーク・在宅ワーク向けヘッドセット比較", "category": "headset", "keyword": "ヘッドセット テレワーク", "subtheme": "テレワーク", "lead": "1日中Web会議に出続ける在宅ワーカー向けのヘッドセット。装着感・マイク品質・接続安定性の3軸で絞り込みました。"},
    {"filename": "article-ノートPCスタンドおすすめ-pm-20260511.html", "title": "ノートPCスタンドおすすめ｜首・肩の負担を減らす1台", "category": "laptop_stand", "keyword": "ノートPCスタンド", "subtheme": "姿勢", "lead": "ノートPCの画面を目線まで上げて、首・肩の負担を減らすスタンド。アルミ製・折りたたみ・角度調整の3軸で選びました。"},
    {"filename": "article-ノートPC対応-大容量モバイルバッテリー-pm-20260510.html", "title": "ノートPC対応・大容量モバイルバッテリー｜出張で電源を気にしない", "category": "mobile_battery", "keyword": "モバイルバッテリー PD", "subtheme": "出張", "lead": "ノートPCを給電できるPD対応モバイルバッテリーを厳選。容量・出力・重量のバランスで在宅ワーカーの外出を支える1台を選びます。"},
    {"filename": "article-ワイヤレスマウスおすすめ-在宅ワーク-pm-20260505.html", "title": "ワイヤレスマウスおすすめ｜在宅ワーク向け静音・エルゴ", "category": "wireless_mouse", "keyword": "ワイヤレスマウス 静音", "subtheme": "静音", "lead": "Web会議中のクリック音が乗らない静音マウス。長時間作業の手首負担を減らすエルゴノミクス設計モデルを優先しました。"},
    {"filename": "article-健康管理に使えるスマートウォッチ-am-20260430.html", "title": "健康管理に使えるスマートウォッチ｜在宅ワーカーの座りすぎ対策", "category": "smartwatch", "keyword": "スマートウォッチ 健康管理", "subtheme": "健康", "lead": "在宅ワーカー最大の敵は座りすぎと運動不足。心拍・ストレス・睡眠の3軸で可視化してくれるスマートウォッチを選びました。"},
    {"filename": "article-毎日持ち歩けるコスパ最強モバイルバッテリー-am-20260512.html", "title": "毎日持ち歩けるコスパ最強モバイルバッテリー｜軽量・PD対応", "category": "mobile_battery", "keyword": "モバイルバッテリー 軽量", "subtheme": "コスパ", "lead": "毎日カバンに入れても苦にならない軽量モバイルバッテリー。10000mAhクラスでPD対応、コスパの良いモデルを楽天実売データで絞りました。"},
    {"filename": "article-通勤-在宅ワーク向けノイキャンイヤホン-am-20260430.html", "title": "通勤・在宅ワーク向けノイキャンイヤホン｜Web会議にも使える1台", "category": "earphone_wireless", "keyword": "ノイズキャンセリング イヤホン", "subtheme": "ノイキャン", "lead": "電車内・カフェ・在宅Web会議。すべての環境で「相手の声に集中できる」ノイキャンイヤホンを選びました。"},
]
